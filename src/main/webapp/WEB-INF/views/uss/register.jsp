...
<body>
    ...
    <script type="text/javascript" src="${mgr}/js/jquery.js"></script>
    <script type="text/javascript" src="${mgr}/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="${mgr}/js/wow.min.js"></script>
    <script type="text/javascript" src="${mgr}/js/coundown-timer.js"></script>
    <script type="text/javascript" src="${mgr}/js/main.js"></script>
    <script type="text/javascript" src="${uss}/js/main.js"></script>
